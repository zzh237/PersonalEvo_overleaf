...
Section~\ref{sec:experiments} reports the base-router results, Hyper-Ridge diagnostics, and remaining evaluation gap. Section~\ref{sec:related} positions the work relative to personalization, agent evolution, routing, and linear bandits. Section~\ref{sec:background} defines the routing problem and Hyper-Ridge estimator, and Section~\ref{sec:theory} develops the decomposition and effective-dimension analysis. Appendix~\ref{app:hyper-proofs} proves the oracle geometry results, and Appendix~\ref{app:err-control-proof} gives the calibration-split covariance theorem.
...
We summarize how this section modifies the base paper. First, the router
changes: the generalized-ridge router defined by
